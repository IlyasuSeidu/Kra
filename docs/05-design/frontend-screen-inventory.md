...
| `PublicCoverage`         | Coverage model             | Explain launch coverage, corridor limits, and expansion rules            | station data when exposed                                                | loading, unavailable, normal          |
...
| `PublicBusiness`         | Business senders           | Explain repeat sender and merchant operating model                       | none                                                                     | normal                                |
| `PublicPartners`         | Partner intake             | Explain station, fleet, and operating partner paths                      | support contact path                                                     | normal, submitted, unavailable        |
| `PublicAbout`            | About Kra                  | Explain company mission, operating principles, and Africa delivery focus | none                                                                     | normal                                |
...
| `PublicCoverage`         | `/coverage`          | `screen-public-coverage`        |
| `PublicPricingExplainer` | `/pricing`           | `screen-public-pricing`         |
| `PublicTrustCustody`     | `/trust-and-custody` | `screen-public-trust-custody`   |
| `PublicBusiness`         | `/business`          | `screen-public-business`        |
| `PublicPartners`         | `/partners`          | `screen-public-partners`        |
| `PublicAbout`            | `/about`             | `screen-public-about`           |
