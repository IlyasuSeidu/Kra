...
export const apiRoutes = [
  ...
  {
    operationId: "create_delivery_proof_asset",
    method: "POST",
    ...
    idempotent: true,
    requestSchema: createProofAssetUploadRequestSchema,
    responseSchema: createProofAssetUploadResponseSchema,
    errorSchema: apiErrorResponseSchema
  },
  {
    operationId: "confirm_delivery_proof_asset_upload",
    method: "POST",
    ...
    capability: "complete_delivery_with_proof",
    idempotent: true,
    requestSchema: confirmProofAssetUploadRequestSchema,
    responseSchema: proofAssetResponseSchema,
    errorSchema: apiErrorResponseSchema
  },
  {
